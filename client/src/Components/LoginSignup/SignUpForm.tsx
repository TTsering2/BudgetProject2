...
export const SignUpForm: React.FC<IProps> = (props: IProps) => {
    ...
    const name = (event.currentTarget.querySelector('input[name="name"]') as HTMLInputElement).value;
    const username = (event.currentTarget.querySelector('input[name="userName"]') as HTMLInputElement).value;
    const password = (event.currentTarget.querySelector('input[name="userPassword"]') as HTMLInputElement).value;
