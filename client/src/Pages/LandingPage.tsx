...
const LandingPage = ({setNavigateToUserCredentials} : Props) => {
    return(
        <div className="bg-[url('/assets/bg.png')] bg-cover bg-center">  
            ...
            <main className="w-[1300px] mx-auto mt-2 mb-10">
                ...
                <section className="flex flex-row mb-1  items-center">
                    <div className="w-11/12">
                        ...
                        <p className="w-8/12 font-medium mt-6">Introducing SpendWise – your go-to financial management app for effortless budgeting. Easily track income and expenses, set budgets, and gain insights into your spending habits. With SpendWise, smart financial decisions are just a tap away. 
                    ...
                    <div className="w-7/12 border-solid">
                        <img src="./assets/wallet.png" alt="wallet" className="w-[480px] m-auto"></img>
                    </div>
                </section>
                ...
                <section  className="flex flex-row items-center justify-between text-center w-[1300px] m-auto pb-14 ">
                    ...
                    <div className="bg-[#2D5872] text-white w-[300px] rounded-lg  h-[190px]">
                        <p className="w-[200px] text-left m-auto mt-8">99.9% uptime and a <b>robust encryption system</b> ensuring the security and privacy of users' financial data</p>
                    </div>
                    <div className="bg-[#2D5872] text-white  rounded-lg w-[300px]  h-[170px]">
                        <p className="w-[200px] text-left m-auto mt-5"><b>70% of SpendWise users</b> report staying within their set budgets each month, leading to improved financial health</p>
                    </div>
